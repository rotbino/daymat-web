...
import { ArrowRight, ChevronDown, ChevronLeft, LayoutGrid } from 'lucide-react';
...
export default function CategorySidebar({ categoryTree }: Props) {
    ...
    // ─── حالت ۱: هیچ دسته‌ای انتخاب نیست → لیست تخت سطح اول ───
    if (!rootNode) {
        return (
            <div className="py-3">
    ...
    // ─── حالت ۲: صفحه تخصصی ریشه → درخت فقطِ فرزندان ریشه ───
    return (
        <div className="py-3">
