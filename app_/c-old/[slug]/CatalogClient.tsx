...
export default function CatalogClient({ slug, initialCatalog, initialSearch = '' }: CatalogClientProps) {
    ...
    const { data: catalog } = useCatalogBySlug(slug);
        ...
        <>
            <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
                ...
                <CatalogHeader
                    ...
                    isOwner={isOwner} // ✅
                    onOpenDashboard={() => router.push(`/${displayCatalog.slug}/dashboard`)}
                />
                ...
                {/* فوتر */}
                <CatalogFooter catalog={displayCatalog} onGoHome={() => router.push('/')} />
