                    ...
                    <div className="relative overflow-hidden rounded-3xl bg-white/70 dark:bg-gray-900/40 backdrop-blur-xl border border-white/60 dark:border-white/10 shadow-xl">
                        ...
                        <div className="px-6 py-5">
                            <div className="flex items-center gap-6">
                                ...
                                {/* اطلاعات */}
                                <div className="flex-1 min-w-0">
                                    <h1 className="text-xl font-extrabold">{catalog.name}</h1>
                                ...
                                <div className="flex items-center gap-3 shrink-0">
                                    {ownerAvatar ? (
                                        <Image src={ownerAvatar} alt={catalog.owner?.fullName || ''} width={52} height={52}
                                    ...
                                    <div>
                                        <p className="text-sm font-bold">{catalog.owner?.fullName}</p>
                ...
                <div className="sm:hidden">
                    <div className="rounded-2xl bg-white/70 dark:bg-gray-900/40 backdrop-blur-xl border shadow-lg overflow-hidden">
                        ...
                        <div className="p-4">
                                ...
                                <div className="relative w-14 h-14 shrink-0">
                                    <div className="w-full h-full rounded-xl p-[2px] bg-gradient-to-tr from-primary via-fuchsia-500 to-amber-400">
                                        <div className="w-full h-full rounded-xl bg-white dark:bg-gray-950 overflow-hidden">
                                            {catalog.logoUrl ? (
                                                <Image src={catalog.logoUrl} alt={catalog.name} fill sizes="56px" className="object-cover" unoptimized />
                                            ) : (
                            ...
                            {catalog.owner?.fullName && (
                                <div className="flex items-center gap-2.5 mt-3">
                                    {ownerAvatar ? (
                                        <Image src={ownerAvatar} alt={catalog.owner.fullName} width={36} height={36}
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-xs font-bold truncate">{catalog.owner.fullName}</p>
