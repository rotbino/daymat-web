...
export default function CatalogFooter({ catalog, onGoHome }: CatalogFooterProps) {
    return (
            ...
            <div className={cn(WRAP, 'py-8')}>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 text-xs">
                    <div>
                        ...
                        {catalog.owner?.phone && catalog.owner?.phone !== catalog.phone && <a href={`tel:${catalog.owner.phone}`} className="block text-gray-500 mt-1" dir="ltr">{catalog.owner.phone}</a>}
