// app/profile/components/CatalogAdsList.tsx
'use client';
...
import { useBulkUpdateAd, useCatalogAds } from '@/lib/api/apiHooks';
...
export default function CatalogAdsList({
                                            catalogId,
                                            totalAds,
                                            activeAds,
                                            expiredAds,
    ...
    // ✅ هوک با status فیلتر
    const { data: adsData, isLoading: adsLoading, refetch: refetchAds } = useCatalogAds(
        catalogId,
        currentPage,
        PAGE_SIZE,
        statusFilter,
    ...
    const handleSaveSlug = async () => {
        ...
        try {
            await apiService.catalog.update(catalogId, { slug: slugInput.trim() });
