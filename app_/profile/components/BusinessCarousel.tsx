// app/profile/components/CatalogCarousel.tsx
'use client';
...
interface Props {
    cataloges: CatalogItem[];
    selectedId: string | null;
    onSelect: (id: string) => void;
}

export default function CatalogCarousel({ cataloges, selectedId, onSelect }: Props) {
    if (!cataloges.length) return null;
        ...
        <div className="w-full max-w-sm mx-auto">
            <Swiper
                ...
                onSlideChange={(swiper) => {
                    ...
                    if (cataloges[index]) {
                        onSelect(cataloges[index].id);
                    }
                }}
                initialSlide={cataloges.findIndex(b => b.id === selectedId)}
