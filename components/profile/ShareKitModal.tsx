...
interface Props {
    ...
    logoUrl?: string;
    /** مسیر پایهٔ صفحهٔ عمومی — پیش‌فرض ریشهٔ سایت (بازوی فروش)؛ بازوی خرید: /inquiries */
    basePath?: string;
...
const COPY_BY_KIND = {
    ...
    inquiry: {
        title: 'کیت اشتراک‌گذاری بازوی خرید',
        ...
        shareText: (name: string) => `بازوی خرید «${name}» — اگه تامین‌کننده‌ای، قیمت بده:`,
