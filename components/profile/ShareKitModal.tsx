...
interface Props {
    ...
    logoUrl?: string;
    /** مسیر پایهٔ صفحهٔ عمومی — پیش‌فرض ریشهٔ سایت (کاتالوگ فروش)؛ فهرست خرید: /inquiries */
    basePath?: string;
    /** نوع محصول — متن‌ها بر همین اساس تنظیم می‌شود (مخاطب کاتالوگ = مشتری؛ مخاطب فهرست خرید = تامین‌کننده) */
...
const COPY_BY_KIND = {
    ...
    inquiry: {
        title: 'کیت اشتراک‌گذاری فهرست خرید',
        ...
        shareText: (name: string) => `فهرست خرید «${name}» — اگه تامین‌کننده‌ای، قیمت بده:`,
