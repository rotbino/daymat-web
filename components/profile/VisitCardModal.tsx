...
//   • امضای برند: آیکون dm آی مچ چسبیده زیر QR (مارجین ~۳px) + اسلاگ — زیرنویس QR زیر آن
...
interface Props {
    ...
    savedSpec?: any;
    /** بعد از ذخیرهٔ موفق — برای تازه‌سازی لیست بازوهای فروش */
    onSaved?: () => void;
}
...
export default function VisitCardModal({ open, onClose, catalogName, slug, logoUrl, phone, description, catalogId, inquiryId, basePath = '', savedSpec, onSaved }: Props) {
    ...
    const drawCard = useCallback(async () => {
        ...
        // ─── آیکون برند آی مچ + اسلاگ — چسبیده زیر QR با ~۳px مارجین (بنا بر بازخورد کاربر) ───
