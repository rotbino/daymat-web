...
/** مقصدهای بی‌طرف خارج از سرور آی مچ */
const PROBE_URLS = [
 ...
 *   اول اینترنت بررسی شود؛ اگر قطع بود سریع به صفحه آفلاین برو و
