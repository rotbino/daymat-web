 ...
 *      ۱. ماژول کاتالوگ فروش      (همیشه فعال — فقط تنظیم دارد)
 *      ۲. ماژول کاتالوگ خرید      (همیشه فعال — همان «تابلوی خریدِ» هر خریدار)
 *      ۳. ماژول دیوار فروشندگان   (قابل خاموش‌کردن — تابلوی قیمت)
 *      ۴. ماژول دیوار خریداران    (قابل خاموش‌کردن — تابلوی خرید بازار)
...
const MODULES: ModuleDef[] = [
    // ۱ ── ماژول کاتالوگ فروش (همیشه فعال)
    {
        key: 'catalog',
        title: 'کاتالوگ فروش',
