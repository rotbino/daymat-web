                        ...
                        <>
                            ...
                            {!selectedBiz && (
                                <p className="mt-2.5 text-[11px] leading-5 text-on-surface-variant/70">
                                    ...
                                    در غیر این صورت، خودت ثبتش کن. تعجب نکن دیمت یه شبکه بزرگه،ممکنه کسب و کارت توسط فروشنده ای که برات کار می کنه ثبت شده باشه.  برای انتخاب یا ثبت کسب و کار لازم نیست مالکش باشی؛
