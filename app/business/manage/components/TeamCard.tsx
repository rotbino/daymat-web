...
//   اینکه چه کسی در کاتالوگ قیمتنده/ویزیتور/ادمین شود، در کاتالوگ قیمت مشخص می‌شود — اینجا فقط نقش در کسب‌وکار.
'use client';
            ...
            <div className="flex items-center gap-2.5 mb-1">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-on-surface-variant/70">
                        نقشِ اعضا در کسب‌وکار — اینکه چه کسی در کاتالوگ قیمتنده یا ویزیتور شود، در کاتالوگ مشخص می‌شود
                    </p>
                </div>
