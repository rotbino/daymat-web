...
// 🏢 صفحه مدیریت کسب‌وکار — مشاهدهٔ کامل مشخصات + ویرایش جداگانهٔ هر بخش با مداد
'use client';
...
export default function BusinessManageContent() {
    ...
    // فقط کسب‌وکارهای قابل‌ویرایش — صفحه، صفحه مدیریت است (ثبت‌کننده/مالک)
    ...
    // ✅ صفحه‌های خرید — برای نمایش کنار کاتالوگ‌های فروش این کسب‌وکار (محصول دوم)
    ...
    // ✅ صفحه‌های خریدِ همین کسب‌وکار — ⚠️ قواعد هوک‌ها: این useMemo باید «قبل از» returnهای شرطی باشد
    ...
    const businessInquiries = useMemo(() => {
        ...
        // فال‌بک برای صفحه‌های خریدِ قدیمی بدون businessId (ساخته‌شده قبل از قابلیت اتصال):
