// app/[slug]/components/CatalogProductList.tsx
'use client';
...
export default function CatalogProductList({
    ...
    return (
        <main className="pb-16">
            ...
            text-amber-700 dark:text-amber-400 text-[11px] font-extrabold flex items-center gap-1
            active:scale-95 transition-transform hover:bg-amber-100 dark:hover:bg-amber-900/50">
                                <Plus className="w-3.5 h-3.5" /> افزودن محصول
                            </button>
                        )}
                ...
                {isLoading ? (
                    ...
                    <div className="text-center py-14">
                        ...
                        {/* ✅ حالت خالی برای مالک: CTA افزودن — همان‌جا */}
