...
//    سرچ‌دار (Autocomplete ریشه) + واحدهای منتخب بازو/کاتالوگ اولِ لیست با بج «واحدهای من»
...
interface Props {
    ...
    /** ✅ واحدهای منتخب بازو/کاتالوگ — اول لیست با بج «واحدهای من» (واحدهای استفاده‌شده همه‌جا می‌آیند) */
...
export default function UnitPicker({
    ...
    // ترتیب: واحدهای من (بازو/کاتالوگ) → پرکاربردها → بقیهٔ مرجع
