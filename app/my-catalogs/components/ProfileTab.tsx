...
export default function ProfileTab({ catalog, completion, canShare, onShare, onEdit, userAvatar, userHasName, onProfile }: {
    ...
    return (
        <div className="space-y-3">
            ...
            {/* ── تکمیل کاتالوگ — سبک قدیمی: افقی، جلوی چشم، تشویق‌کننده ── */}
            {percent === 100 ? (
                <div className="rounded-xl border border-emerald-300/50 bg-gradient-to-l from-emerald-50/80 to-emerald-50/30
                    ...
                    <p className="flex-1 text-xs font-extrabold text-emerald-800 dark:text-emerald-300 leading-5">
                ...
                <div className="rounded-xl border border-outline-variant/50 dark:border-gray-700 bg-white dark:bg-gray-900 overflow-hidden">
