...
const EVENT_LABEL: Record<string, string> = {
    ...
    buyer_rejected: 'اعلام خریدارش رد شد',
...
export default function TeamTab({ catalogId }: Props) {
    ...
    //    ۱) خریدارها — از روی اعلام خریدشان (نه فقط کسب‌وکارشان)
                    ...
                    <div key={m.id} className={cn(
                        ...
                        >
                            ...
                            <p className="text-[11px] text-gray-500 dark:text-gray-400 truncate mt-0.5 flex items-center gap-2">
                                ...
                                {/* ✅ اعلام خریدِ خریدار — شبکهٔ خرید↔فروش */}
    ...
    return (
        <div className="space-y-4">
            ...
            {/* ✅ خریدارها — از روی اعلام خریدشان (قلب شبکهٔ خرید↔فروش) */}
