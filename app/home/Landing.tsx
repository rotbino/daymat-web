              ...
              <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
                ...
                <span className="inline-flex items-center gap-1.5 rounded-full bg-stone-900 px-3 py-1 text-xs font-bold text-white dark:bg-gray-100 dark:text-gray-900">
                  ...
                  <p className="mt-4 text-justify text-sm leading-8 text-stone-600 dark:text-gray-400 sm:text-base">
                    دیمت قرار نیست همه را به همه وصل کند؛ هدفش این است که هر فروشنده در کاتالوگ خودش با خریدارانی روبه‌رو شود که واقعاً مشتری محصولاتش هستند، و هر خریدار هم با کمک بازوی خریدش به تأمین‌کننده‌هایی وصل شود که واقعاً می‌توانند نیازش را به بهترین نحو تأمین کنند.
