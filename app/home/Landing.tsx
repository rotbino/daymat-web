              ...
              <div className="mx-auto max-w-8xl px-4 pb-14 pt-12 sm:px-6 sm:pt-16">
                ...
                <div className="relative mx-auto mt-10  flex max-w-4xl flex-col gap-4 md:flex-row md:gap-6">
                  ...
                  <HeroBox
                      ...
                      body=" بازوی فروش محصولات یا خدماتت رو بساز. لینکش رو به مشتریان مرتبط بفرست؛ هر مشتری که به این بازو وصل بشه ، بخشی از شبکه فروشت میشه و همیشه بازوی فروشهای روز شما رو داره.دیمت هم شبکه خریدارنت رو گسترش میده."
                      delay={0.1}
                  />
