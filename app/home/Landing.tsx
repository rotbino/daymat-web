 ...
 *   قرمز لاکی برند = کاتالوگ فروش (نمایش و تبلیغ)  |  کهربایی برند = کاتالوگ قیمت (استعلام و خرید)
 ...
 *   X برای کاتالوگ قیمت = فرم ساخت (/inquiries/new)
 * نکتهٔ مهم: لینک کاتالوگ فروش فقط به دست خریدارها می‌رسد و
 * لینک کاتالوگ قیمت فقط به دست تامین‌کننده‌ها — هرگز قاطی نمی‌شوند.
 */
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 border-b border-dashed border-amber-300 pb-2 dark:border-amber-500/40">
        ...
        <span className="text-[11px] font-bold text-stone-700 dark:text-gray-200">کاتالوگ قیمت من</span>
    ...
    <section aria-label="همین حالا توی دیمت" className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
      <motion.div {...fadeUp()} className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 leading-8 text-stone-600 dark:text-gray-400">
          قیمت‌های واقعی فروشنده‌ها همین حالا روی تابلوی دیمت است — و کاتالوگ قیمت هم چند دقیقه بیشتر نمی‌برد.
        </p>
      </motion.div>
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        ...
        <motion.div {...fadeUp(0.2)}
          ...
          <h3 className="flex items-center gap-2 text-lg font-black text-amber-600 dark:text-amber-400">
            <ClipboardList className="size-5" /> کاتالوگ قیمت
          </h3>
          <p className="mt-3 text-sm font-bold leading-7 text-stone-500 dark:text-gray-400">
            لیست خریدت را بنویس — تامین‌کننده‌ها کاتالوگ قیمتهایت را می‌بینند و قیمت می‌دهند؛
...
export default function Landing() {
  ...
  const purchaseHref = toolHref('/inquiries/new');    // کاتالوگ قیمت — فرم ساخت (محصول مستقل)
        ...
        <main id="top" className="flex-1">
          ...
          <section aria-label="معرفی" className="relative overflow-hidden">
            <div className="mx-auto max-w-6xl px-4 pb-12 pt-14 text-center sm:px-6 sm:pt-20">
              ...
              <motion.p
                ...
                و «کاتالوگ قیمت» برای استعلام قیمت چیزی که می‌خری. هر کدام یک لینک جداست؛
              ...
              <motion.div
                ...
                <div className="flex flex-col items-center gap-3">
                  ...
                  <span
                    ...
                    کاتالوگ قیمت — لینکش مالِ تامین‌کننده‌ها
                  </span>
                </div>
              </motion.div>
            </div>
          ...
          <section aria-label="دو ابزار" className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
            <motion.div {...fadeUp()} className="mx-auto max-w-2xl text-center">
              ...
              <h2 className="mt-2 text-3xl font-black leading-snug sm:text-4xl">
                ...
                <span className="text-brand-amber">کاتالوگ قیمت</span>
              </h2>
              <p className="mt-4 leading-8 text-stone-600 dark:text-gray-400">
                هر کدام چند دقیقه‌ای ساخته می‌شود و یک لینک ساده تحویل می‌دهد؛
                هر لینک هم فقط به مسیر خودش می‌رود — کاتالوگ فروش پیش خریدارها، کاتالوگ قیمت پیش تامین‌کننده‌ها.
              </p>
            </motion.div>
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2 md:gap-8">
              ...
              <ProductCard
                ...
                desc="لیست چیزهایی که می‌خری رو بنویس، لینک کاتالوگ قیمتت رو بده تامین‌کننده‌ها؛ اون‌ها قیمت بدن، تو بهترین رو انتخاب کن."
                ...
                steps={[
                  ...
                  },
                  {
                    ...
                    desc: 'فقط همین لینک کاتالوگ قیمت پخش می‌شه؛ کاتالوگ فروشت اصلاً درگیر این ماجرا نیست.',
                  },
                  {
          ...
          <section aria-label="شبکهٔ خرید و فروش" className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
            <motion.div {...fadeUp()} className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 leading-8 text-stone-600 dark:text-gray-400">
                خریدار تامین‌کننده‌هاش را از روی کاتالوگ فروششان به کاتالوگ قیمتش اضافه می‌کند؛
                هر وقت چیزی فوری لازم داشت، کاتالوگ قیمتش مستقیم دست همان‌ها می‌رسد.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  desc: 'قلم را می‌نویسی، تیک «کاتالوگ قیمت» را می‌زنی — بالای کاتالوگت می‌نشیند.',
                },
                {
                  icon: BellRing,
                  tone: 'red' as const,
                  title: 'تامین‌کنندهٔ تاییدشده فوری می‌فهمد',
                  desc: 'کاتالوگ قیمت در تب «کاتالوگ قیمت»ی پنل فروشش می‌آید و اعلان می‌گیرد.',
                },
                {
                  icon: Handshake,
                  tone: 'amber' as const,
              ...
              <motion.div
                ...
                <div className="mt-6 space-y-5">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-7 text-stone-600 dark:text-gray-400">
                      هر وقت خواست جنس عمده بخره، یه کاتالوگ قیمت جدا می‌سازه و فقط لینک همون رو می‌ده دست کارخونه‌ها.
                    </p>
                  </div>
                </div>
              </motion.div>
        ...
        <footer className="mt-auto border-t border-stone-200 bg-[#FFFDF7] dark:border-gray-800 dark:bg-gray-950">
          <div
            ...
            <div className="flex items-center gap-2.5">
              ...
              <span className="hidden text-sm text-stone-400 dark:text-gray-500 sm:inline">— فروش با کاتالوگ فروش، خرید با کاتالوگ قیمت</span>
            </div>
