// app/ad/edit/components/PaymentSection.tsx
'use client';
...
export function PaymentSection({ paymentMethods, setPaymentMethods }: PaymentSectionProps) {
                            ...
                            <div className="space-y-2 pt-2 border-t border-gray-200 dark:border-gray-700">
                                ...
                                {paymentMethods.cheque.options.map((opt, idx) => (
                                    <div key={idx} className="grid grid-cols-1 sm:grid-cols-2 gap-2 border-t border-gray-200 dark:border-gray-700 pt-2">
                                        <div>
                                            <label className="text-xs text-gray-500 dark:text-gray-400">قیمت چکی هر واحد (تومان)</label>
                                            <NumberInput
                                                value={opt.price}
                                                onChange={(val) => {
                                                    const newOptions = [...paymentMethods.cheque.options];
