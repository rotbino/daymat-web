...
// تب انتشار پنل اعلام خرید — قرینهٔ تب انتشار کاتالوگ فروش:
    ...
    return (
        <div className="space-y-3">
            ...
            <motion.section
                ...
                <h2 className="mb-3 text-[12px] font-black text-stone-400 dark:text-gray-500">لینک اعلام خرید</h2>
            ...
            {/* 🪪 کارت ویزیت اعلام خرید — برای تامین‌کننده‌ها (بنا بر خواستهٔ کاربر) */}
                ...
                <div className="flex items-start gap-2.5">
                    ...
                    <div className="min-w-0 flex-1">
                        <p className="text-xs font-extrabold text-stone-700 dark:text-gray-200">
                            {visibility === 'private'
                                ? 'این اعلام خرید خصوصیه — فقط تامین‌کننده‌های تاییدشده می‌بینن'
                                : visibility === 'unlisted'
                                    ? 'این اعلام خرید فقط با لینک دیده می‌شه'
                                    : 'این اعلام خرید عمومیه — هرکس لینک را داشته باشد می‌بیند'}
                        </p>
        ...
        return (
            <motion.button type="button" onClick={onOpen}
                ...
                <span className="h-[41px] w-[72px] shrink-0 overflow-hidden rounded-lg bg-white shadow-sm ring-1 ring-stone-200 dark:ring-gray-700">
                    ...
                    <img src={cardPreview} alt="کارت ویزیت اعلام خرید" className="size-full object-cover" />
                </span>
                <span className="min-w-0 flex-1">
                    <span className="block text-sm font-extrabold text-stone-800 dark:text-gray-200">کارت ویزیت اعلام خرید</span>
    ...
    return (
        <motion.button type="button" onClick={onOpen}
            ...
            <span className="min-w-0 flex-1">
                ...
                <span className="mt-0.5 block text-[11px] font-bold text-stone-400 dark:text-gray-500">
                    طرح چاپی ۹×۵ با QR اعلام خرید — کلاس‌کار بمان تویی
                </span>
            </span>
        </motion.button>
    );
