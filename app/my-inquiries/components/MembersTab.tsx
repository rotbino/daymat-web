...
// ✅ تب «تامین‌کنندگان» پنل صفحه درخواست خرید — شبکهٔ خرید↔فروش:
//    تامین‌کننده‌های تاییدشده این کاتالوگ، اعلام خریدهای فوری را اول از همه می‌بینند
//    و در تب «درخواست خریدها»ی پنل فروششان قیمت می‌دهند.
            ...
            <div className={`${card} flex items-center gap-3 p-4`}>
                ...
                <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 text-[11px] font-bold leading-5 text-stone-400 dark:text-gray-500">
                        {visibility === 'private'
                            ? 'اعلام خریدهایت فقط همین‌ها می‌بینند'
                            : 'اعلام خریدهای فوریت را اول از همه می‌بینند و قیمت می‌دهند'}
                    </p>
                </div>
                <button
                        ...
                        {active.length === 0 && invited.length === 0 ? (
                            <div className="px-4 py-8 text-center">
                                ...
                                <p className="mx-auto mt-1 max-w-xs text-[11px] font-bold leading-5 text-stone-400 dark:text-gray-500">
                                    تامین‌کننده‌هایت را اضافه کن تا اعلام خریدهایت دستشان برسد
                                </p>
                            </div>
                        ) : (
                            <>
        ...
        <div className="fixed inset-0 z-[85] flex items-end sm:items-center justify-center sm:p-4" onClick={onClose}>
            ...
            >
                ...
                <p className="mt-0.5 text-[11px] font-bold text-stone-400 dark:text-gray-500">
                    از کاتالوگ فروششان دعوت کن — اعلام خریدهایت دستشان می‌رسد
                </p>
